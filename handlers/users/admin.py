...
async def reply_feedback(message: types.Message):
    await bot.forward_message(message.reply_to_message.forward_from.id, message.from_user.id, message.message_id)
